...
declare type WebViewCommands = 'goForward' | 'goBack' | 'reload' | 'stopLoading' | 'postMessage' | 'injectJavaScript' | 'loadUrl' | 'requestFocus' | 'saveSnapshot';
...
export interface ViewManager {
    ...
    saveSnapshot: (nodeId: number, path: string, asPNG?: boolean) => Promise<string>;
}
