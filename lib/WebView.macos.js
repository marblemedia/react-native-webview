...
var WebView = /** @class */ (function (_super) {
    ...
    function WebView() {
        ...
        _this.saveSnapshot = function (path, asPNG) {
            UIManager.dispatchViewManagerCommand(_this.getWebViewHandle(), _this.getCommands().saveSnapshot, [String(path), Boolean(asPNG)]);
        };
        /**
